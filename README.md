...
When looking at the twenty most frequent patterns in the larger windows, reasoning that the smaller patterns wouldn't be that useful since they wouldn't be big enough to give me much information, I found that with a few exceptions the predominant patterns were scales with the occasional arpeggio or turnaround in it. So the most common run of 6 notes in the key of G is: ![here](/img/top_twenty_patterns_6.png?raw=true)
